...
dt = @elapsed _, R_norm, pcg_iters = pcr_spai(A, Pr, copy(M0), itmax["pcr"], tol, s, eval_pcg=true)
npzwrite("data/Experiment07_" * matrix * "_R_norm_pcr_spai.npz", R_norm)
npzwrite("data/Experiment07_" * matrix * "_pcg_iters_pcr_spai.npz", pcg_iters)
