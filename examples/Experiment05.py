...
R_norm_pmr = np.load("data/Experiment05_" + matrix + "_R_norm_pmr_spai_it100.npz")
R_norm_pcg = np.load("data/Experiment05_" + matrix + "_R_norm_pcg_spai_it100.npz")
R_norm_lopmr = np.load("data/Experiment05_" + matrix + "_R_norm_lopmr_spai_it100.npz")
