...
M_spectrum_lopmr = np.load("data/Experiment01_" + matrix + "_spectrum_lopmr_spd.npz")
M_spectrum_pcg = np.load("data/Experiment01_" + matrix + "_spectrum_pcg.npz")
M_spectrum_pmr = np.load("data/Experiment01_" + matrix + "_spectrum_pmr_spd.npz")
#M_spectrum_npcg = np.load("data/Experiment01_" + matrix + "_spectrum_npcg.npz")
M_spectrum_psd = np.load("data/Experiment01_" + matrix + "_spectrum_psd_spd.npz")

spectra = {r'$A^{-1}$': A_spectrum,
           'LOPMR_SPD': M_spectrum_lopmr,
           'PCG': M_spectrum_pcg,
           'PMR_SPD': M_spectrum_pmr,
           #'NPCG': M_spectrum_npcg,
           'PSD_SPD': M_spectrum_psd}
