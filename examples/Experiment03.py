...
R_norm_pmr = np.load("data/Experiment03_" + matrix + "_R_norm_pmr_spd.npz")
R_norm_pcg = np.load("data/Experiment03_" + matrix + "_R_norm_pcg.npz")
R_norm_lopmr = np.load("data/Experiment03_" + matrix + "_R_norm_lopmr_spd.npz")
...
M = mmread("data/Experiment03_" + matrix + "_M_pmr_spd.mtx")
if False:
...
M = mmread("data/Experiment03_" + matrix + "_M_lopmr_spd.mtx")
if False:
