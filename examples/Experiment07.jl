...
dt = @elapsed _, R_norm, pcg_iters = lopmr_spd_spai(A, Pr, copy(M0), itmax["lopmr"], tol, s, eval_pcg=true)
npzwrite("data/Experiment07_" * matrix * "_R_norm_lopmr_spd_spai.npz", R_norm)
npzwrite("data/Experiment07_" * matrix * "_pcg_iters_lopmr_spd_spai.npz", pcg_iters)

dt = @elapsed _, R_norm, pcg_iters = pmr_spd_spai(A, Pr, copy(M0), itmax["pmr"], tol, s, eval_pcg=true)
npzwrite("data/Experiment07_" * matrix * "_R_norm_pmr_spd_spai.npz", R_norm)
npzwrite("data/Experiment07_" * matrix * "_pcg_iters_pmr_spd_spai.npz", pcg_iters)
