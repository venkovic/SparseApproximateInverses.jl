...
M_spectrum_lopmr = np.load("data/Experiment02_" + matrix + "_spectrum_lopmr_spd.npz")
M_spectrum_pcg = np.load("data/Experiment02_" + matrix + "_spectrum_pcg.npz")
M_spectrum_pmr = np.load("data/Experiment02_" + matrix + "_spectrum_pmr_spd.npz")
...
plt.savefig("img/Experiment02_" + matrix + "_spectra.png", bbox_inches='tight', dpi=300)